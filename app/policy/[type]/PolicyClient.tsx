    ...
    <Content>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          결제) 또는 매월 반복 결제 모두 결제일로부터 7일 이내에는 청약철회(전액
          환불)가 가능합니다.
        </Paragraph>
        <Paragraph>
          <strong>7일 이후 환불 규정:</strong> 결제일로부터 7일이 지난 경우에는
          청약철회가 아닌 해지 및 부분 환불 규정이 적용됩니다.
        </Paragraph>
        <Paragraph>
        ...
        <Paragraph>
          <strong>멤버십 정지 및 환불 요청 방법:</strong> 멤버십 해지 및 환불은
          프로필 페이지에서 직접 신청하실 수 있습니다.
        </Paragraph>
      </Section>
