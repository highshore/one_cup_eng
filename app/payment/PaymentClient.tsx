...
const OptionCard = styled.div<{ $selected: boolean; $disabled?: boolean }>`
  ...
  &:hover {
    border-color: ${(props) =>
      props.$disabled ? "#e0e0e0" : props.$selected ? "#2c1810" : "#ccc"};
...
const OptionPrice = styled.span<{ $highlighted?: boolean }>`
  ...
  background: ${(props) =>
    props.$highlighted
      ? "linear-gradient(90deg, #fff3e0, #ffecb3)"
      : "transparent"};
      ...
      {userData?.hasActiveSubscription ? (
        <AlreadySubscribedCard>
          ...
          <AlreadySubscribedText>
            이미 멤버십을 이용 중입니다. 현재 멤버십 플랜은 프로필 페이지에서
            확인 가능합니다.
          </AlreadySubscribedText>
          <ActionButton
            $variant="secondary"
        ...
        <>
          <SectionCard>
            ...
            <OptionsGrid>
              ...
              <OptionCard $selected={true} $disabled={true}>
                <OptionHeader>
                  <OptionIcon>📰</OptionIcon>
            ...
            <FeaturesList>
              ...
              <FeatureItem>
                통역사 및 다양한 업계 종사자와 실전 영어 대화
              </FeatureItem>
              <FeatureItem>소규모 그룹 (5명 이하) 집중 학습</FeatureItem>
              <FeatureItem>
                매주 해외에서 가장 핫한 영어 아티클 제공
              </FeatureItem>
          ...
          >
            {isProcessing ? (
              ...
              `월 ${totalAmount.toLocaleString()}원에 멤버십 시작하기`
            )}
          </ActionButton>
          ...
          <PolicyCard>
            ...
            <PolicySection>
              ...
              <PolicyText>
                요금제에 가입하시면 결제 시점을 기준으로 30일 후 자동 결제가
                진행됩니다.
              </PolicyText>
            </PolicySection>
            ...
            <PolicySection>
              ...
              <PolicyText>
                결제일로부터 7일이 지난 경우에는 청약철회가 아닌 해지 및 부분
                환불 규정이 적용됩니다.
              </PolicyText>
            </PolicySection>
            ...
            <PolicySection>
              ...
              <PolicyText>
                예) 월 멤버십을 20일 사용 후 해지한 경우, 남은 10일분(30일
                기준)에 해당하는 금액을 다음과 같이 환불해드립니다:
              </PolicyText>
              <PolicyText>
